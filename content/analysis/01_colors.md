...
<div class="table-wrapper">
    <table>
        ...
        <tr>
            <td>Discord</td>
            <td>ABCGinto, sans-serif</td>
            <td>Ggsans, sans-serif</td>
            <td>Triad/Square</td>
        </tr>
        <tr>
            <td>Skype</td>
            <td>Segoe UI Bold, sans-serif</td>
            <td>Segoe UI, sans-serif</td>
            <td>Monokromatiskt</td>
        </tr>
        <tr>
            <td>Slack</td>
            <td>Slack-Larsseit, <br>Helvetica, sans-serif</td>
            <td>Slack-Circular-Pro,<br>Helvetica, sans-serif</td>
            <td>Square</td>
        </tr>
    </table>
</div>
